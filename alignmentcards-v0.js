...
export const cards = [
  ...
  { 
    ...
    "Pathology/Alignment Failure": "Short-term correctedness: optimizing for easy grades that distort true learning goals.", 
    "Affirmative Design": "Reward durable learning and conceptual transfer, design metrics that reward synthesis, application, and retention over time", 
  ...
  { 
    ...
    "Pathology/Alignment Failure": "Throughput over care: efficiency metrics replace patient outcomes, leading to burnout and lower quality of treatment.", 
    "Affirmative Design": "Measure care by recovery, not paperwork; reward systems that improve patient well-being, follow up consistency, and prevention."", 
